...
class FakeTopicElement {
    ...
    static let item1 = Item(id: "AAA", title: "Item 1", content: [], links: [], mode: "essential")
    static let item2 = Item(id: "AAB", title: "Item 2", content: [], links: [], mode: "intermediate")
    static let item3 = Item(id: "AAC", title: "Item 3", content: [], links: [], mode: "advanced")
